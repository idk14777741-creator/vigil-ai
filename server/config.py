...
APP_NAME = "VIGIL AI"
APP_VERSION = "0.20.0 (stress load score — separate deterministic second indicator with personal baselines, three-indicator dashboard; on top of v0.19 intelligence & privacy layer and v0.18 offline-first welfare transfer)"
